...
YOUTUBE = YouTubeIt::Client.new(:dev_key => "AI39si5Dgg_9QnLn4JihtOcgxLKti3okDDvvulrnOAeQ8rArYrD6gFn0ALhi_T124PxthsSGtxTEhwhiKNrzpygcENYakw7tVA")

# activity = YOUTUBE.activity("yoojcheme")
